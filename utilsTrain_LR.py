...
def train_model(name_file,model, optimizer, scheduler,dataloaders,name_model='UNet11',num_epochs=40):
    ...
    best_loss = 1e10
    f = open("history_LR/history_model{}_{}.txt".format(name_file,name_model), "w+")
