...
do
  for j in 0 1 2 3 4
    do
    python train.py --fold-out $i  --fold-in $j --percent 0.08 --n-epochs 40  
...
do
  for j in 0 1 2 3 4
    do
    python train.py --fold-out $i  --fold-in $j --percent 0.20 --n-epochs 40
...
do
  for j in 0 1 2 3 4
    do
    python train.py --fold-out $i  --fold-in $j --percent 0.40 --n-epochs 40
...
do
  for j in 0 1 2 3 4
    do
    python train.py --fold-out $i  --fold-in $j --percent 0.80 --n-epochs 40
