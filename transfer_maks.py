...
original_dataset_dir = "data_HR/train/images/"
#original_dataset_dir = "../../data/dataset/hr_image/data/train/images/"

print(original_dataset_dir)
label_dir  = "data_HR/data/masks/"
data_dir  = "data_HR/train/masks/"
# copying files to their correspondig folder-------------------------
## Getting names of all files in the folder------------------------------------
