...
def read_metric(out_file,stage,name_file, name,name_model,fold_out,fold_in,epochs):
    ...
    plt.show()
    f.savefig(("predictions_{}/metric_{}_{}{}_{}_foldout{}_foldin{}_{}epochs.pdf").format(out_file,name,stage,name_file,name_model,fold_out,fold_in,epochs), bbox_inches='tight')
...
def plot_history_train(out_file,name_file,name_model,fold_out,fold_in,epochs):
    file = open(("history_{}/history_model{}_{}_foldout{}_foldin{}_{}epochs.txt").format(out_file,name_file,name_model,fold_out,fold_in,epochs), "r")
    ...
    plt.legend()
    plt.show()
    f.savefig(("history_{}/loss_convergence{}_{}_foldout{}_foldin{}_{}epochs.pdf").format(out_file,name_file,name_model,fold_out,fold_in,epochs), bbox_inches='tight') 
    plt.close()
 #  
...
def main():   
    ...
    arg('--out-file', type=str, default='VHR', help='For example VHR, paral, seq')
